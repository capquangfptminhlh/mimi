(() => {
  ...
  style.textContent = `
    ...
    .lumi-contact-call{background:#10b981}.lumi-contact-zalo{background:#0068ff}
    .lumi-contact-icon{font-size:16px;line-height:1}
    @media(max-width:640px){.lumi-contact-rail{right:10px;bottom:84px;gap:8px}.lumi-contact-rail a{min-width:48px;width:48px;height:48px;padding:0;border-radius:16px}.lumi-contact-label{display:none}}
    @media(prefers-reduced-motion:reduce){.lumi-paw-loader span{animation:none}.lumi-reveal{opacity:1;transform:none;transition:none}.lumi-page-transition{transition:none}}
  `;
